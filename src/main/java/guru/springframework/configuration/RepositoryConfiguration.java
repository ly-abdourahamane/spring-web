...
@EntityScan(basePackages = {"guru.springframework.domain"}) //specifies the packages to look for JPA Entities
@EnableJpaRepositories(basePackages = {"guru.springframework.repositories"}) //enables the auto configuration of Spring Data JPA
